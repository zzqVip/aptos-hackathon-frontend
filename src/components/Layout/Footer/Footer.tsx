...
import mediumLogo from "../../../assets/logo/medium_logo.png";
      ...
      <div className={classes.footerArea}>
        ...
        <div className={classes.cbiLogo}>
          <a href="https://cbindex.finance/" target="_blank">
            <img src={cbiLogo} alt={"cbi"} width={48} height={50} />
          </a>
        </div>
        ...
        <div className={classes.socialMediaIconArea}>
          <a
            ...
            target="_blank"
          >
            <img src={xLogo} alt={"x"} width={26} height={26} />
          </a>
          <a
            className={classes.socialMediaIcon}
          ...
          <a
            ...
            target="_blank"
          >
            <img src={mediumLogo} alt={"github"} width={24} height={24} />
          </a>
        </div>
